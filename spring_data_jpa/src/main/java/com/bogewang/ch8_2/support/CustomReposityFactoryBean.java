...
public class CustomReposityFactoryBean<T extends JpaRepository<S, ID>, S, ID extends Serializable>
extends JpaRepositoryFactoryBean<T, S, ID>{

    public CustomReposityFactoryBean(Class<? extends T> repositoryInterface) {
